...
void main() {
	...
	MatrixXd parameters_guess{
		{119.77,242.0,18}  //Initial Guess for parameters: Scaled the first parameter by 1e3
	};
	...
	MatrixXd Parameters = GradientDescent(parameters_guess, initial_deflection, y_measured, area_1, area_2, len_1, len_2, t_total, ForceMax);
